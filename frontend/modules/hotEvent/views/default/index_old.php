    ...
    <div class="content-area">
            ...
            <div id="main-slider" class="owl-carousel owl-theme">
                ...
                <div class="item page text-center slide5">
                    ...
                    <div class="container">
                        <div class="div-table">
                        <div class="div-cell">
                            <p class="text-center avatar"><img src="/gevents/frontend/web/hotevent/img/preview/slider-4-avatar.png" style="width: auto;" alt=""/></p>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <h1 class="section-title two-lines">
                            ...
                            <span data-animation="fadeInRight" data-animation-delay="500" class="title-inner">Featured Event <small>Dont Miss The Event. PHP Conference In ISTANBUL</small></span>
                        </h1>
                    </div>
                    <div class="col-md-4">
        ...
        <section class="page-section">
            <div class="container">
                ...
                <div class="clear clearfix overflowed">
                    <h1 class="section-title pull-left" style="width: auto;">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="media">
                                        ...
                                        <img src="/gevents/frontend/web/hotevent/img/preview/event-1.jpg" alt="">
        ...
        <section class="page-section">
            <div class="container">
                ...
                <div class="text-center margin-top">
                    <a data-animation="fadeInUp" data-animation-delay="100" href="#" class="btn btn-theme btn-theme-grey-dark btn-theme-md"><i class="fa fa-file-text-o"></i> See all hotels</a>
                </div>
                        ...
                        <div class="media-object pull-right" data-animation="flipInY" data-animation-delay="300">
                            <div class="rehex testimonial-avatar">
                                <div class="rehex-deg">
                                    <div class="rehex-deg">
                                        <div class="rehex-inner">
                                            <img class="img-responsive" src="/gevents/frontend/web/hotevent/img/preview/avatar-1.jpg" alt=""/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="media-object pull-right" data-animation="flipInY" data-animation-delay="300">
                            <div class="rehex testimonial-avatar">
                                <div class="rehex-deg">
                                    <div class="rehex-deg">
                                        <div class="rehex-inner">
                                            <img class="img-responsive" src="/gevents/frontend/web/hotevent/img/preview/avatar-2.jpg" alt=""/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="media-object pull-right" data-animation="flipInY" data-animation-delay="300">
                            <div class="rehex testimonial-avatar">
                                <div class="rehex-deg">
                                    <div class="rehex-deg">
                                        <div class="rehex-inner">
                                            <img class="img-responsive" src="/gevents/frontend/web/hotevent/img/preview/avatar-3.jpg" alt=""/>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container full-width">
                ...
                <div class="row thumbnails no-padding gallery isotope isotope-items">
                    ...
                    <div class="col-md-3 col-sm-6 isotope-item photos ">
                        <div class="thumbnail no-border no-padding">
                            <div class="media">
                                <img src="/gevents/frontend/web/hotevent/img/preview/latest-1a.jpg" alt="">
                                <div class="caption hovered">
                                    <div class="caption-wrapper div-table">
                                        <div class="caption-inner div-cell">
                    ...
                    <div class="col-md-3 col-sm-6 isotope-item videos">
                        <div class="thumbnail no-border no-padding">
                            <div class="media">
                                <img src="/gevents/frontend/web/hotevent/img/preview/latest-2a.jpg" alt="">
                                <div class="caption hovered">
                                    <div class="caption-wrapper div-table">
                                        <div class="caption-inner div-cell">
                                            <p class="caption-buttons">
                    ...
                    <div class="col-md-3 col-sm-6 isotope-item gallery">
                        <div class="thumbnail no-border no-padding">
                            <div class="media">
                                <img src="/gevents/frontend/web/hotevent/img/preview/latest-3a.jpg" alt="">
                                <div class="caption hovered">
                                    <div class="caption-wrapper div-table">
                                        <div class="caption-inner div-cell">
                                            <p class="caption-buttons">
                    ...
                    <div class="col-md-3 col-sm-6 isotope-item photos gallery">
                        <div class="thumbnail no-border no-padding">
                            <div class="media">
                                <img src="/gevents/frontend/web/hotevent/img/preview/latest-4a.jpg" alt="">
                                <div class="caption hovered">
                                    <div class="caption-wrapper div-table">
                                        <div class="caption-inner div-cell">
                                            <p class="caption-buttons">
                    ...
                    <div class="col-md-3 col-sm-6 isotope-item photos videos">
                        <div class="thumbnail no-border no-padding">
                            <div class="media">
                                <img src="/gevents/frontend/web/hotevent/img/preview/latest-5a.jpg" alt="">
                                <div class="caption hovered">
                                    <div class="caption-wrapper div-table">
                                        <div class="caption-inner div-cell">
                                            <p class="caption-buttons">
                    ...
                    <div class="col-md-3 col-sm-6 isotope-item videos gallery">
                        <div class="thumbnail no-border no-padding">
                            <div class="media">
                                <img src="/gevents/frontend/web/hotevent/img/preview/latest-6a.jpg" alt="">
                                <div class="caption hovered">
                                    <div class="caption-wrapper div-table">
                                        <div class="caption-inner div-cell">
                                            <p class="caption-buttons">
                    ...
                    <div class="col-md-3 col-sm-6 isotope-item photos videos">
                        <div class="thumbnail no-border no-padding">
                            <div class="media">
                                <img src="/gevents/frontend/web/hotevent/img/preview/latest-7a.jpg" alt="">
                                <div class="caption hovered">
                                    <div class="caption-wrapper div-table">
                                        <div class="caption-inner div-cell">
                                            <p class="caption-buttons">
                    ...
                    <div class="col-md-3 col-sm-6 isotope-item gallery">
                        <div class="thumbnail no-border no-padding">
                            <div class="media">
                                <img src="/gevents/frontend/web/hotevent/img/preview/latest-8a.jpg" alt="">
                                <div class="caption hovered">
                                    <div class="caption-wrapper div-table">
                                        <div class="caption-inner div-cell">
                                            <p class="caption-buttons">
                            ...
                            <div class="rehex speaker-avatar">
                                <div class="rehex-deg">
                                    <div class="rehex-deg">
                                        <div class="rehex-inner">
                                            <div class="media">
                                                <img src="/gevents/frontend/web/hotevent/img/preview/speaker-4.jpg" alt="">
                                                <div class="caption hovered">
                                                    <div class="caption-wrapper div-table">
                                                        <div class="caption-inner div-cell">
                                                            <p class="caption-buttons"><a href="#" class="btn caption-link"><i class="fa fa-link"></i></a></p>
        ...
        <section class="page-section">
            <div class="container">
                    ...
                    <div class="col-md-4">
                        <article class="post-wrap" data-animation="fadeInUp" data-animation-delay="100">
                            <div class="post-media">
                                ...
                                <img src="/gevents/frontend/web/hotevent/img/preview/recent-post-1.jpg" alt=""/>
                            </div>
                    ...
                    <div class="col-md-4">
                        <article class="post-wrap" data-animation="fadeInUp" data-animation-delay="300">
                            <div class="post-media">
                                ...
                                <img src="/gevents/frontend/web/hotevent/img/preview/recent-post-2.jpg" alt=""/>
                            </div>
                            <div class="post-header">
                                <h2 class="post-title"><a href="#">Standart Blog Post Header Here</a></h2>
                                <div class="post-meta">
                    ...
                    <div class="col-md-4">
                        <article class="post-wrap" data-animation="fadeInUp" data-animation-delay="500">
                            <div class="post-media">
                                ...
                                <img src="/gevents/frontend/web/hotevent/img/preview/recent-post-3.jpg" alt=""/>
                            </div>
                            <div class="post-header">
                                <h2 class="post-title"><a href="#">Standart Blog Post Header Here</a></h2>
                                <div class="post-meta">
                ...
                <div class="text-center margin-top">
                    <a data-animation="flipInY" data-animation-delay="100" href="blog.html" class="btn btn-theme btn-theme-grey-dark btn-theme-md"><i class="fa fa-file"></i> See all news</a>
                </div>
            </div>
        </section>
        <!-- /PAGE -->

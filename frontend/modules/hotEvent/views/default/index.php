				...
				<div class="row">
					<div class="col-md-8 pull-left">
						<h1 class="section-title">
							...
							<span class="title-inner">FAQ´s DO EVENTO <small> / encontre suas respostas</small></span>
						</h1>
					</div>
					<div class="col-md-4 text-right-md pull-right">
						<a href="#" class="btn btn-theme btn-theme-lg btn-theme-transparent-grey pull-right"><i class="fa fa-pencil"></i> AINDA ESTÁ COM DÚVIDAS ?</a>
					</div>
				</div>

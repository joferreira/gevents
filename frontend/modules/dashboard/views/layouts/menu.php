		...
		<ul class="nav navbar-top-links navbar-right">
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu dropdown-user">
					<li><a href="index.php?r=dashboard/cadastro"><i class="fa fa-user fa-fw"></i> Meus dados</a>
					</li>
					<li><a href="#"><i class="fa fa-gear fa-fw"></i> Settings</a>
					</li>
					<li class="divider"></li>
					<li><a href="index.php?r=cliente/logout"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
					</li>
				</ul>
				<!-- /.dropdown-user -->
			</li>
		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li>
						<a href="<?= Yii::$app->urlManager->createAbsoluteUrl('dashboard');?>"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
					</li>
					<li>
					...
					<li>
						...
						<ul class="nav nav-second-level">
							...
							<li>
								<a href="<?= Yii::$app->urlManager->createAbsoluteUrl('dashboard/ingresso');?>">Meus ingressos</a>
							</li>
							<li>

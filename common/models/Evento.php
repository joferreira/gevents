...
class Evento extends \yii\db\ActiveRecord
{
	...
	{
		return [
			[['TIPO_EVENTO_INT_ID_TIPO_EVENTO', 'STATUS_INT_ID_STATUS', 'STR_NOME', 'DAT_DATA_INICIO', 'DAT_DATA_FINAL', 'TIM_HORA_INICIO', 'TIM_HORA_FINAL', 'STR_LOCAL_REALIZACAO', 'STR_EMAIL_CONTATO'], 'required'],
	...
	public function attributeLabels()
	{
		return [
			...
			'INT_FAX_DDD' => 'Fax Ddd',
			'INT_FAX' => 'Fax',
			'INT_PAGAMENTO_ATIVO' => 'Evento Pago',
		];
	}
	...
	public function saveEvento($arrDados = array()) {
		try {
			...
			if( isset($arrDados['INT_ID_EVENTO']) ){
